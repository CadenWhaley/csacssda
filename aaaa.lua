...
local ut
local lt
local WeldBase = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart")
if true then 
	singulartorso = true
...
game.Players.LocalPlayer.Character.Head:GetPropertyChangedSignal("CanCollide"):Connect(function()
    game.Players.LocalPlayer.Character.Head.CanCollide=false
end)
if game.Players.LocalPlayer.Character:FindFirstChild("LowerTorso") then
    game.Players.LocalPlayer.Character.LowerTorso.CanCollide=false
    game.Players.LocalPlayer.Character.LowerTorso:GetPropertyChangedSignal("CanCollide"):Connect(function()
        game.Players.LocalPlayer.Character.LowerTorso.CanCollide=false
    end)
    game.Players.LocalPlayer.Character.UpperTorso.CanCollide=false
    game.Players.LocalPlayer.Character.UpperTorso:GetPropertyChangedSignal("CanCollide"):Connect(function()
        game.Players.LocalPlayer.Character.UpperTorso.CanCollide=false
    end)
else
    game.Players.LocalPlayer.Character.Torso.CanCollide=false
    game.Players.LocalPlayer.Character.Torso:GetPropertyChangedSignal("CanCollide"):Connect(function()
        game.Players.LocalPlayer.Character.Torso.CanCollide=false
    end)
end
...
e = game.RunService.RenderStepped:Connect(function()
	local ActiveTracks = Humanoid:GetPlayingAnimationTracks()
	for _,v in pairs(ActiveTracks) do
    v:Stop()
	end
	--char.Humanoid:Move(game.Players.LocalPlayer.Character.Humanoid.MoveDirection, false)
end)
